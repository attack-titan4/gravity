  ...
  return (
    <>
      ...
      <div className="company-name1">
        Due to the impact of Covid-19, we are currently experiencing minor delays with our shipping carrier 
        <div className="shipping">Free shipping over $999<br/>Free 5-day return shipping</div>
      </div>
      ...
      <div className="footer-style2">
        <div className="social-media-icons">
          <a href="https://www.facebook.com"><FaFacebook className="icon-style" /></a>
          <a href="https://www.twitter.com"><FaTwitter className="icon-style" /></a>
          <a href="https://www.instagram.com"><FaInstagram className="icon-style" /></a>
          <a href="https://www.pinterest.com"><FaPinterest className="icon-style" /></a>
        </div>
      </div>
      ...
      <div className="footer-style1">
        ...
        <NavLink to="/" className="nav-link">Dressmart Cares</NavLink>
      </div>

      <div className="footer-links">
        <Link className="nav-link">Sitemap</Link> | <Link className="nav-link">Terms of Service</Link> | <Link className="nav-link">Privacy Policy</Link>
      </div>
